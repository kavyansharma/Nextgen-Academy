    ...
    <div className="relative min-h-screen bg-slate-50 text-slate-900 flex flex-col justify-between overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10 w-full">
        ...
        <div className="text-center space-y-4 max-w-3xl mx-auto mb-16">
          ...
          <p className="text-sm sm:text-md text-slate-650 max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-5 space-y-6">
            {contactInfo.map((item, idx) => {
              ...
              return (
                <div key={idx} className="p-6 rounded-2xl bg-white border border-slate-200 shadow-sm flex items-start gap-4 hover:border-slate-300 hover:shadow-md transition-all duration-300">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="font-semibold text-brand-orange text-sm">{item.details}</p>
            ...
            <div className="p-6 rounded-2xl bg-slate-100/60 border border-slate-200 text-xs text-slate-600 flex items-center gap-3">
          ...
          <div className="lg:col-span-7">
            <div className="p-8 rounded-3xl bg-white border border-slate-200 shadow-md relative overflow-hidden">
              <h2 className="text-2xl font-bold text-slate-900 mb-6">Send A Query</h2>
              <ContactForm />
            </div>
          </div>
        </div>
