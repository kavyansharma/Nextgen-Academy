...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen bg-slate-50 flex flex-col justify-between overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/4 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-blue-500/5 rounded-full blur-[120px] pointer-events-none"></div>
      <div className="absolute bottom-1/4 right-1/4 translate-x-1/2 translate-y-1/2 w-[600px] h-[600px] bg-sky-500/5 rounded-full blur-[140px] pointer-events-none"></div>
      ...
      <section className="relative pt-24 pb-20 md:pt-32 md:pb-28 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-8 text-center lg:text-left">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-blue-50 border border-blue-100 text-blue-600 text-xs font-semibold tracking-wide uppercase animate-fade-in">
              <Activity className="w-3.5 h-3.5" />
              <span>Industrial & Manufacturing Specialists</span>
            </div>
            
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-slate-900 leading-tight animate-fade-in-up">
              Talent. Train.<br />
            ...
            <p className="text-base sm:text-lg text-slate-600 leading-relaxed max-w-2xl mx-auto lg:mx-0 animate-fade-in-up animate-delay-100">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-4 animate-fade-in-up animate-delay-200">
              <Link 
                ...
                className="w-full sm:w-auto px-8 py-4 rounded-xl bg-blue-600 hover:bg-blue-750 text-white font-semibold transition-all duration-300 hover:scale-[1.02] text-center shadow-md shadow-blue-500/10 cursor-pointer"
              >
                Book Discovery Call
              </Link>
              <Link 
                href="/get-in-touch/recruiter" 
                className="w-full sm:w-auto px-8 py-4 rounded-xl bg-white border border-slate-200 hover:border-blue-600 text-slate-700 hover:text-blue-600 font-semibold transition-all duration-300 hover:scale-[1.02] text-center hover:bg-slate-50 cursor-pointer flex items-center justify-center gap-2 group shadow-sm"
              >
          ...
          <div className="lg:col-span-5 relative flex justify-center animate-fade-in animate-delay-200">
            <div className="relative w-full max-w-md p-8 rounded-3xl bg-white border border-slate-200 shadow-xl overflow-hidden group">
              ...
              <div className="relative space-y-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-slate-900 font-bold text-lg">NextGen Trust</h3>
                    <p className="text-xs text-slate-500">High-impact human solutions</p>
                  </div>
                </div>
                ...
                <ul className="space-y-4">
                  {highlights.map((highlight, index) => (
                    <li key={index} className="flex items-center gap-3 text-sm text-slate-650">
                      <CheckCircle2 className="w-4.5 h-4.5 text-blue-650 flex-shrink-0" />
                      <span>{highlight}</span>
                    </li>
                  ))}
                </ul>
                ...
                <div className="pt-2">
                  <Link href="/about" className="text-xs font-semibold text-blue-600 hover:text-blue-700 flex items-center gap-1.5">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {stats.map((stat, index) => (
              <div 
                key={index} 
                className="p-8 rounded-2xl bg-slate-50/50 border border-slate-100 text-center hover:border-blue-600/30 transition-all duration-300 group"
              >
                <div className="text-4xl lg:text-5xl font-extrabold text-slate-900 group-hover:text-blue-600 transition-colors duration-300">
                  {stat.value}
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {valueProps.map((prop, index) => {
            ...
            return (
              <div 
                key={index}
                className="p-8 rounded-2xl bg-white border border-slate-200 shadow-sm hover:border-blue-600/30 hover:shadow-md hover:scale-[1.01] transition-all duration-300 flex flex-col justify-between"
              >
                <div className="space-y-6">
                  <div className="w-12 h-12 rounded-xl bg-slate-50 border border-slate-100 flex items-center justify-center text-blue-650">
                ...
                <div className="pt-6">
                  <Link 
                    href="/services" 
                    className="inline-flex items-center gap-1.5 text-sm font-semibold text-blue-650 hover:text-blue-700 group"
                  >
      ...
      <section className="relative py-16 bg-white border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-8">
          ...
          <div className="flex flex-wrap items-center justify-center gap-8 md:gap-16 opacity-80">
            {["AUTOMOTIVE & EV", "HEAVY ENGINEERING", "INDUSTRIAL MFG", "FMCG LEADING BRANDS", "TECH SYSTEMS"].map((sector, i) => (
              <div key={i} className="text-sm md:text-base font-extrabold tracking-wider text-slate-400 hover:text-slate-800 transition-colors duration-200">
                {sector}
              </div>
            ))}
          </div>
