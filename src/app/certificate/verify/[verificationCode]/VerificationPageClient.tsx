...
export default function VerificationPageClient({ verificationCode }: VerificationPageClientProps) {
      ...
      <div className="w-full max-w-xl bg-slate-900/60 border border-white/5 shadow-2xl rounded-3xl p-8 glass relative overflow-hidden z-10">
        ...
        {loading ? (
          ...
          <div className="space-y-6 text-center py-4">
            ...
            <div className="bg-slate-955 p-4.5 rounded-2xl border border-white/5 text-xs text-left text-slate-400 space-y-2 max-w-md mx-auto">
