      ...
      <div className="max-w-3xl mx-auto relative space-y-8">
        ...
        <div className="bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 shadow-sm space-y-6 text-slate-700 text-sm leading-relaxed">
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">1. Acceptable Use</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">2. Candidate Sourcing & Engagements</h2>
            <p>
          ...
          <section className="space-y-3">
            <h2 className="text-lg font-bold text-slate-900">3. Academy Certification Rules</h2>
            <p>
